 ...
 * @property hasNext Flag indicating if there is a next page available.
 * @property cursor The cursor for the current page.
 * @property nextPageCursor The cursor for the next page, if available.
 * @property totalCount The total count of items across all pages, if available.
 */
data class PageInfo(
    val pageSize: Int,
    val hasNext: Boolean,
