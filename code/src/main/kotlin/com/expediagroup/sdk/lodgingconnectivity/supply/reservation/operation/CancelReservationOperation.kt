 ...
 *
 * This function uses the provided [AbstractGraphQLExecutor] to execute the mutation and returns a [CancelReservationResponse]
...
fun cancelReservationOperation(
...
): CompletableFuture<CancelReservationResponse> {
    ...
    return graphQLExecutor.execute(operation).thenApply {
        CancelReservationResponse(
            data = it.data.cancelReservation.reservation?.reservationData,
            rawResponse = it
        )
    }
}
