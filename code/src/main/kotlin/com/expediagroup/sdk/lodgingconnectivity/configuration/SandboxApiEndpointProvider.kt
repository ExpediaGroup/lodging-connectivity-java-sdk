...
/**
 * Provides needed endpoints for EG lodging connectivity Sandbox GraphQL API, configured based on the specified client environment.
 */
class SandboxApiEndpointProvider private constructor() {
    companion object {
         ...
         * [ClientEnvironment] to ensure compatibility with different environments (e.g., SANDBOX_PROD, SANDBOX_TEST).
         *
         * @param environment The [ClientEnvironment] specifying the target environment (e.g., SANDBOX_PROD, SANDBOX_TEST).
