...
import com.expediagroup.sdk.core2.logging.masking.maskLogs
...
internal class LoggerDecorator(private val logger: Logger) : Logger by logger {
     ...
     */
    private fun decorate(msg: String, tags: Set<LogMessageTag> = emptySet()): String =
        "${Constant.LOGGING_PREFIX} ${normalize(msg, tags)}".trim()
}
