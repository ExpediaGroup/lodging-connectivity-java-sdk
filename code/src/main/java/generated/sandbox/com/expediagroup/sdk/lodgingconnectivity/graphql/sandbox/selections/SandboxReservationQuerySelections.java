...
public class SandboxReservationQuerySelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("reservation", new CompiledNotNullType(Reservation.type)).arguments(Arrays.asList(new CompiledArgument.Builder(Query.__reservation_id).value(new CompiledVariable("id")).build())).selections(__reservation).build()
  );
}
