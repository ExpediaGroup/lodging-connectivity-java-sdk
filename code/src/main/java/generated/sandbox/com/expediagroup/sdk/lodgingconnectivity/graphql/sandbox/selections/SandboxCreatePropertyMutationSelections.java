...
public class SandboxCreatePropertyMutationSelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("createProperty", new CompiledNotNullType(CreatePropertyPayload.type)).arguments(Arrays.asList(new CompiledArgument.Builder(Mutation.__createProperty_input).value(new CompiledVariable("input")).build())).selections(__createProperty).build()
  );
}
