...
public class SandboxPropertyQuerySelections {
  ...
  private static List<CompiledSelection> __property = Arrays.asList(
    ...
    new CompiledField.Builder("reservations", new CompiledNotNullType(ReservationsResponse.type)).condition(Arrays.asList(new CompiledCondition("skipReservations", true))).arguments(Arrays.asList(new CompiledArgument.Builder("cursor", new CompiledVariable("reservationsCursor")).build(), new CompiledArgument.Builder("limit", new CompiledVariable("reservationsLimit")).build())).selections(__reservations).build()
  );

  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("property", new CompiledNotNullType(Property.type)).arguments(Arrays.asList(new CompiledArgument.Builder("id", new CompiledVariable("id")).build())).selections(__property).build()
  );
}
