...
public class SandboxPropertyQuerySelections {
  ...
  private static List<CompiledSelection> __reservations = Arrays.asList(
    ...
    new CompiledField.Builder("elements", new CompiledNotNullType(new CompiledListType(new CompiledNotNullType(Reservation.type)))).selections(__elements).build()
  );
  ...
  private static List<CompiledSelection> __property = Arrays.asList(
    ...
    new CompiledField.Builder("reservations", new CompiledNotNullType(ReservationsResponse.type)).condition(Arrays.asList(new CompiledCondition("skipReservations", true))).arguments(Arrays.asList(new CompiledArgument.Builder(Property.__reservations_cursor).value(new CompiledVariable("reservationsCursor")).build(), new CompiledArgument.Builder(Property.__reservations_limit).value(new CompiledVariable("reservationsLimit")).build())).selections(__reservations).build()
  );

  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("property", new CompiledNotNullType(Property.type)).arguments(Arrays.asList(new CompiledArgument.Builder(Query.__property_id).value(new CompiledVariable("id")).build())).selections(__property).build()
  );
}
