...
import com.expediagroup.sdk.lodgingconnectivity.graphql.sandbox.type.UpdateReservationPayload;
import java.util.Arrays;
import java.util.List;

public class SandboxUpdateReservationMutationSelections {
  ...
  private static List<CompiledSelection> __updateReservation = Arrays.asList(
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("updateReservation", new CompiledNotNullType(UpdateReservationPayload.type)).arguments(Arrays.asList(new CompiledArgument.Builder(Mutation.__updateReservation_input).value(new CompiledVariable("input")).build())).selections(__updateReservation).build()
  );
}
