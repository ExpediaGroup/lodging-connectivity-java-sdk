...
public class SandboxUpdateReservationMutationSelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("updateReservation", new CompiledNotNullType(UpdateReservationPayload.type)).arguments(Arrays.asList(new CompiledArgument.Builder("input", new CompiledVariable("input")).build())).selections(__updateReservation).build()
  );
}
