...
public class PropertyPromotionsQuerySelections {
  ...
  private static List<CompiledSelection> __property = Arrays.asList(
    new CompiledField.Builder("promotions", new CompiledNotNullType(Promotions.type)).arguments(Arrays.asList(new CompiledArgument.Builder(Property.__promotions_after).value(new CompiledVariable("after")).build(), new CompiledArgument.Builder(Property.__promotions_filter).value(new CompiledVariable("filter")).build(), new CompiledArgument.Builder(Property.__promotions_pageSize).value(new CompiledVariable("pageSize")).build())).selections(__promotions).build()
  );
