...
public class UpdateUnitSpacesBedroomInput {
  ...
  public UpdateUnitSpacesBedroomInput(Optional<Optional<List<BedGroupInput>>> bedGroups, String id,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof UpdateUnitSpacesBedroomInput) {
      UpdateUnitSpacesBedroomInput that = (UpdateUnitSpacesBedroomInput) o;
  ...
  public String toString() {
    if ($toString == null) {
      $toString = "UpdateUnitSpacesBedroomInput{"
        + "bedGroups=" + bedGroups + ", "
        + "id=" + id + ", "
        + "order=" + order + ", "
        + "text=" + text
  ...
  public static final class Builder {
    ...
    public UpdateUnitSpacesBedroomInput build() {
      return new UpdateUnitSpacesBedroomInput(bedGroups, id, order, text);
    }
  }
}
