...
public class DeleteImageMutationSelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("deleteImage", DeleteImagePayload.type).arguments(Arrays.asList(new CompiledArgument.Builder(Mutation.__deleteImage_input).value(new CompiledVariable("input")).build())).selections(__deleteImage).build()
  );
}
