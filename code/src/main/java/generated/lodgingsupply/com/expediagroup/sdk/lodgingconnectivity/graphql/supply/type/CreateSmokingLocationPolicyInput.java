...
public class CreateSmokingLocationPolicyInput {
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof CreateSmokingLocationPolicyInput) {
      CreateSmokingLocationPolicyInput that = (CreateSmokingLocationPolicyInput) o;
  ...
  public String toString() {
    if ($toString == null) {
      $toString = "CreateSmokingLocationPolicyInput{"
        + "allowed=" + allowed + ", "
  ...
  public static final class Builder {
    ...
    public CreateSmokingLocationPolicyInput build() {
      return new CreateSmokingLocationPolicyInput(allowed, allowedNote);
    }
  }
}
