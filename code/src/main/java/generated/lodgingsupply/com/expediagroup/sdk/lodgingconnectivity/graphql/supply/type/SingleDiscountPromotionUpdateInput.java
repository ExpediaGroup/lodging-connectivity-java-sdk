...
public class SingleDiscountPromotionUpdateInput {
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof SingleDiscountPromotionUpdateInput) {
      SingleDiscountPromotionUpdateInput that = (SingleDiscountPromotionUpdateInput) o;
  ...
  public String toString() {
    if ($toString == null) {
      $toString = "SingleDiscountPromotionUpdateInput{"
        + "id=" + id + ", "
        + "name=" + name + ", "
        + "status=" + status + ", "
        + "category=" + category + ", "
  ...
  public static final class Builder {
    ...
    public SingleDiscountPromotionUpdateInput build() {
      return new SingleDiscountPromotionUpdateInput(id, name, status, category, code, restrictions, eligibleRatePlans, blackoutDates, discount);
    }
  }
}
