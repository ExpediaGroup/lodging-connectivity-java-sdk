...
public class CreateNotificationCallbackConfigMutationSelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("createNotificationCallbackConfig", CreateNotificationCallbackConfigPayload.type).arguments(Arrays.asList(new CompiledArgument.Builder("input", new CompiledVariable("input")).build())).selections(__createNotificationCallbackConfig).build()
  );
}
