...
import com.expediagroup.sdk.lodgingconnectivity.graphql.supply.type.SetMessageThreadSpamStatusPayload;
import java.util.Arrays;
import java.util.List;

public class SetMessageThreadSpamStatusMutationSelections {
  private static List<CompiledSelection> __setMessageThreadSpamStatus = Arrays.asList(
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("setMessageThreadSpamStatus", SetMessageThreadSpamStatusPayload.type).arguments(Arrays.asList(new CompiledArgument.Builder(Mutation.__setMessageThreadSpamStatus_input).value(new CompiledVariable("input")).build())).selections(__setMessageThreadSpamStatus).build()
  );
}
