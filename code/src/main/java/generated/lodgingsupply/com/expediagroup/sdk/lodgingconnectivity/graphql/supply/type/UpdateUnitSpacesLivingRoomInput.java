...
public class UpdateUnitSpacesLivingRoomInput {
  ...
  public UpdateUnitSpacesLivingRoomInput(Optional<Optional<List<BedGroupInput>>> bedGroups,
      String id, Optional<Optional<Integer>> order, Optional<Optional<List<TextInput>>> text) {
