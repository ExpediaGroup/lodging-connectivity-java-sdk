...
public class CreateDayOfWeekDiscountPromotionMutationSelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("createDayOfWeekDiscountPromotion", new CompiledNotNullType(Promotion.type)).arguments(Arrays.asList(new CompiledArgument.Builder("promotion", new CompiledVariable("promotion")).build(), new CompiledArgument.Builder("propertyId", new CompiledVariable("propertyId")).build(), new CompiledArgument.Builder("propertyIdSource", new CompiledVariable("propertyIdSource")).build())).selections(__createDayOfWeekDiscountPromotion).build()
  );
}
