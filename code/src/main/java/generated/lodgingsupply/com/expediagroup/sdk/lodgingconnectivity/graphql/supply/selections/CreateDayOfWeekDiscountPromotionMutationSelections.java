...
public class CreateDayOfWeekDiscountPromotionMutationSelections {
  ...
  private static List<CompiledSelection> __createDayOfWeekDiscountPromotion = Arrays.asList(
    new CompiledField.Builder("__typename", new CompiledNotNullType(GraphQLString.type)).build(),
    new CompiledField.Builder("category", new CompiledNotNullType(PromotionCategory.type)).build(),
    new CompiledField.Builder("id", new CompiledNotNullType(GraphQLID.type)).build(),
    new CompiledField.Builder("isContractedPromotion", GraphQLBoolean.type).build(),
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("createDayOfWeekDiscountPromotion", new CompiledNotNullType(Promotion.type)).arguments(Arrays.asList(new CompiledArgument.Builder(Mutation.__createDayOfWeekDiscountPromotion_promotion).value(new CompiledVariable("promotion")).build(), new CompiledArgument.Builder(Mutation.__createDayOfWeekDiscountPromotion_propertyId).value(new CompiledVariable("propertyId")).build(), new CompiledArgument.Builder(Mutation.__createDayOfWeekDiscountPromotion_propertyIdSource).value(new CompiledVariable("propertyIdSource")).build())).selections(__createDayOfWeekDiscountPromotion).build()
  );
}
