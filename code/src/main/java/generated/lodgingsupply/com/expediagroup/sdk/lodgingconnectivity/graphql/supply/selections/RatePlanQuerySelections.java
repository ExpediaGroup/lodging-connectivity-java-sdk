...
public class RatePlanQuerySelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("ratePlan", RatePlan.type).arguments(Arrays.asList(new CompiledArgument.Builder("propertyId", new CompiledVariable("propertyId")).build(), new CompiledArgument.Builder("ratePlanId", new CompiledVariable("ratePlanId")).build())).selections(__ratePlan).build()
  );
}
