...
public class UpdateDayOfWeekDiscountPromotionMutationSelections {
  ...
  private static List<CompiledSelection> __updateDayOfWeekDiscountPromotion = Arrays.asList(
    new CompiledField.Builder("__typename", new CompiledNotNullType(GraphQLString.type)).build(),
    new CompiledField.Builder("category", new CompiledNotNullType(PromotionCategory.type)).build(),
    new CompiledField.Builder("id", new CompiledNotNullType(GraphQLID.type)).build(),
    new CompiledField.Builder("isContractedPromotion", GraphQLBoolean.type).build(),
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("updateDayOfWeekDiscountPromotion", new CompiledNotNullType(Promotion.type)).arguments(Arrays.asList(new CompiledArgument.Builder(Mutation.__updateDayOfWeekDiscountPromotion_promotion).value(new CompiledVariable("promotion")).build(), new CompiledArgument.Builder(Mutation.__updateDayOfWeekDiscountPromotion_propertyId).value(new CompiledVariable("propertyId")).build(), new CompiledArgument.Builder(Mutation.__updateDayOfWeekDiscountPromotion_propertyIdSource).value(new CompiledVariable("propertyIdSource")).build())).selections(__updateDayOfWeekDiscountPromotion).build()
  );
}
