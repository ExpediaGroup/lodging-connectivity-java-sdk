...
public enum VrboCancellationPolicyOverride_InputAdapter implements Adapter<VrboCancellationPolicyOverride> {
  ...
  public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
    ...
    if (value.penalty.isPresent()) {
      writer.name("penalty");
      new OptionalAdapter<>(new OptionalAdapter<>(new ObjectAdapter<VrboCancellationPolicyPenalty>(VrboCancellationPolicyPenalty_InputAdapter.INSTANCE, false))).toJson(writer, customScalarAdapters, value.penalty);
    }
  }
}
