...
public class PropertyReservationsQuerySelections {
  ...
  private static List<CompiledSelection> __property = Arrays.asList(
    new CompiledField.Builder("reservations", new CompiledNotNullType(ReservationsConnection.type)).arguments(Arrays.asList(new CompiledArgument.Builder(Property.__reservations_after).value(new CompiledVariable("after")).build(), new CompiledArgument.Builder(Property.__reservations_checkOutDate).value(new CompiledVariable("checkOutDate")).build(), new CompiledArgument.Builder(Property.__reservations_filter).value(new CompiledVariable("filter")).build(), new CompiledArgument.Builder(Property.__reservations_pageSize).value(new CompiledVariable("pageSize")).build())).selections(__reservations).build()
  );
