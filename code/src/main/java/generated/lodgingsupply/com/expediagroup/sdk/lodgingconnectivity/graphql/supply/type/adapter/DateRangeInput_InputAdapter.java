...
public enum DateRangeInput_InputAdapter implements Adapter<DateRangeInput> {
  INSTANCE;

  @Override
  public DateRangeInput fromJson(JsonReader reader, CustomScalarAdapters customScalarAdapters)
      throws IOException {
  ...
  public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
      DateRangeInput value) throws IOException {
    writer.name("from");
