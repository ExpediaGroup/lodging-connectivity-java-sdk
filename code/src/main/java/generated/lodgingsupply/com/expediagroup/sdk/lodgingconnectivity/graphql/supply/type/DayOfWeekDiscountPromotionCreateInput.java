...
public class DayOfWeekDiscountPromotionCreateInput {
  ...
  public final DayOfWeekDiscountCreateInput discount;
  ...
  public DayOfWeekDiscountPromotionCreateInput(PromotionName name, PromotionStatus status,
      ...
      DayOfWeekDiscountCreateInput discount) {
    this.name = name;
    this.status = status;
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof DayOfWeekDiscountPromotionCreateInput) {
      DayOfWeekDiscountPromotionCreateInput that = (DayOfWeekDiscountPromotionCreateInput) o;
  ...
  public String toString() {
    if ($toString == null) {
      $toString = "DayOfWeekDiscountPromotionCreateInput{"
        + "name=" + name + ", "
        + "status=" + status + ", "
        + "category=" + category + ", "
        + "code=" + code + ", "
  ...
  public static final class Builder {
    ...
    private DayOfWeekDiscountCreateInput discount;
     ...
     */
    public Builder discount(DayOfWeekDiscountCreateInput discount) {
      this.discount = discount;
      return this;
    }

    public DayOfWeekDiscountPromotionCreateInput build() {
      return new DayOfWeekDiscountPromotionCreateInput(name, status, category, code, restrictions, eligibleRatePlans, blackoutDates, discount);
    }
  }
}
