...
public class CreateSingleDiscountPromotionMutation_ResponseAdapter {
  ...
  public enum CreateSingleDiscountPromotion implements Adapter<CreateSingleDiscountPromotionMutation.CreateSingleDiscountPromotion> {
    ...
    public CreateSingleDiscountPromotionMutation.CreateSingleDiscountPromotion fromJson(
      ...
      CreateSingleDiscountPromotionMutation.OnDiscountPromotion _onDiscountPromotion = null;
      if (BooleanExpressions.evaluate(new BooleanExpression.Element<BTerm>(new BPossibleTypes("DiscountPromotion")), customScalarAdapters.getAdapterContext().variables(), __typename, customScalarAdapters.getAdapterContext(), null)) {
        reader.rewind();
        _onDiscountPromotion = com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.CreateSingleDiscountPromotionMutation_ResponseAdapter.OnDiscountPromotion.INSTANCE.fromJson(reader, customScalarAdapters);
      }
    ...
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
      ...
      if (value.onDiscountPromotion != null) {
        com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.CreateSingleDiscountPromotionMutation_ResponseAdapter.OnDiscountPromotion.INSTANCE.toJson(writer, customScalarAdapters, value.onDiscountPromotion);
      }
    }
  }
  ...
  public enum OnDiscountPromotion implements Adapter<CreateSingleDiscountPromotionMutation.OnDiscountPromotion> {
    ...
    public CreateSingleDiscountPromotionMutation.OnDiscountPromotion fromJson(JsonReader reader,
      ...
      PromotionStatus _status = null;
      String _code = null;
      CreateSingleDiscountPromotionMutation.Restrictions _restrictions = null;
      List<CreateSingleDiscountPromotionMutation.EligibleRatePlan> _eligibleRatePlans = null;
      List<CreateSingleDiscountPromotionMutation.BlackoutDate> _blackoutDates = null;
      CreateSingleDiscountPromotionMutation.Discount _discount = null;
      PromotionSellStatus _sellStatus = null;
      Boolean _isContractedPromotion = null;
      ...
      while(true) {
        switch (reader.selectName(RESPONSE_NAMES)) {
          ...
          case 5: _restrictions = new NullableAdapter<>(new ObjectAdapter<CreateSingleDiscountPromotionMutation.Restrictions>(Restrictions.INSTANCE, false)).fromJson(reader, customScalarAdapters); break;
          ...
          case 7: _blackoutDates = new NullableAdapter<>(new ListAdapter<>(new ObjectAdapter<CreateSingleDiscountPromotionMutation.BlackoutDate>(BlackoutDate.INSTANCE, false))).fromJson(reader, customScalarAdapters); break;
          case 8: _discount = new NullableAdapter<>(new ObjectAdapter<CreateSingleDiscountPromotionMutation.Discount>(Discount.INSTANCE, true)).fromJson(reader, customScalarAdapters); break;
    ...
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
      ...
      new NullableAdapter<>(new ObjectAdapter<CreateSingleDiscountPromotionMutation.Restrictions>(Restrictions.INSTANCE, false)).toJson(writer, customScalarAdapters, value.restrictions);
      ...
      new NullableAdapter<>(new ListAdapter<>(new ObjectAdapter<CreateSingleDiscountPromotionMutation.BlackoutDate>(BlackoutDate.INSTANCE, false))).toJson(writer, customScalarAdapters, value.blackoutDates);

      writer.name("discount");
      new NullableAdapter<>(new ObjectAdapter<CreateSingleDiscountPromotionMutation.Discount>(Discount.INSTANCE, true)).toJson(writer, customScalarAdapters, value.discount);
  ...
  public enum Discount implements Adapter<CreateSingleDiscountPromotionMutation.Discount> {
    ...
    public CreateSingleDiscountPromotionMutation.Discount fromJson(JsonReader reader,
      ...
      Assertions.checkFieldNotMissing(__typename, "__typename");
      CreateSingleDiscountPromotionMutation.OnSingleDiscount _onSingleDiscount = null;
      if (BooleanExpressions.evaluate(new BooleanExpression.Element<BTerm>(new BPossibleTypes("SingleDiscount")), customScalarAdapters.getAdapterContext().variables(), __typename, customScalarAdapters.getAdapterContext(), null)) {
        reader.rewind();
        _onSingleDiscount = com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.CreateSingleDiscountPromotionMutation_ResponseAdapter.OnSingleDiscount.INSTANCE.fromJson(reader, customScalarAdapters);
      }
    ...
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
      ...
      if (value.onSingleDiscount != null) {
        com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.CreateSingleDiscountPromotionMutation_ResponseAdapter.OnSingleDiscount.INSTANCE.toJson(writer, customScalarAdapters, value.onSingleDiscount);
      }
    }
  }
