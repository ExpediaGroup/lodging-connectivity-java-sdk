...
public class MessageQuerySelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("message", MessageThreadMessage.type).arguments(Arrays.asList(new CompiledArgument.Builder("id", new CompiledVariable("messageId")).build())).selections(__message).build()
  );
}
