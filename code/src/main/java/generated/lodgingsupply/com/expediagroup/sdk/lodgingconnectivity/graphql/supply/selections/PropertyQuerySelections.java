...
public class PropertyQuerySelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("property", Property.type).arguments(Arrays.asList(new CompiledArgument.Builder("id", new CompiledVariable("id")).build(), new CompiledArgument.Builder("idSource", "EXPEDIA").build())).selections(__property).build()
  );
}
