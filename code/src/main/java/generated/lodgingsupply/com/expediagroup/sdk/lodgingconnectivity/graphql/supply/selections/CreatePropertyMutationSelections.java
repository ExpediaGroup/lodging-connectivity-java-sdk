...
import com.expediagroup.sdk.lodgingconnectivity.graphql.supply.type.CreatePropertyPayload;
...
public class CreatePropertyMutationSelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("createProperty", CreatePropertyPayload.type).arguments(Arrays.asList(new CompiledArgument.Builder(Mutation.__createProperty_input).value(new CompiledVariable("input")).build())).selections(__createProperty).build()
  );
}
