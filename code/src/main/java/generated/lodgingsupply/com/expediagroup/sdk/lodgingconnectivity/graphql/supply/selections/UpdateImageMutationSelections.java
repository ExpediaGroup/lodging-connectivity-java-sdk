...
public class UpdateImageMutationSelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("updateImage", UpdateImagePayload.type).arguments(Arrays.asList(new CompiledArgument.Builder("input", new CompiledVariable("input")).build())).selections(__updateImage).build()
  );
}
