...
public class SavePropertyContactMutationSelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("savePropertyContact", Contact.type).arguments(Arrays.asList(new CompiledArgument.Builder(Mutation.__savePropertyContact_contact).value(new CompiledVariable("contact")).build(), new CompiledArgument.Builder(Mutation.__savePropertyContact_propertyId).value(new CompiledVariable("propertyId")).build())).selections(__savePropertyContact).build()
  );
}
