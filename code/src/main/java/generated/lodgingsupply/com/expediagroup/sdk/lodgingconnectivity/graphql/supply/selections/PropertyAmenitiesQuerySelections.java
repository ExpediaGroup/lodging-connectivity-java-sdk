...
public class PropertyAmenitiesQuerySelections {
  ...
  private static List<CompiledSelection> __property = Arrays.asList(
    new CompiledField.Builder("amenities", new CompiledListType(new CompiledNotNullType(Amenity.type))).arguments(Arrays.asList(new CompiledArgument.Builder("filters", new CompiledVariable("filters")).build())).selections(__amenities).build()
  );
