...
public class PropertyFeeSetsQuerySelections {
  ...
  private static List<CompiledSelection> __property = Arrays.asList(
    new CompiledField.Builder("feeSets", PropertyFeeSetsResponse.type).arguments(Arrays.asList(new CompiledArgument.Builder(Property.__feeSets_filters).value(new CompiledVariable("filters")).build())).selections(__feeSets).build()
  );
