...
public class CreateFeeSetMutationSelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("createFeeSet", CreateFeeSetPayload.type).arguments(Arrays.asList(new CompiledArgument.Builder("input", new CompiledVariable("input")).build())).selections(__createFeeSet).build()
  );
}
