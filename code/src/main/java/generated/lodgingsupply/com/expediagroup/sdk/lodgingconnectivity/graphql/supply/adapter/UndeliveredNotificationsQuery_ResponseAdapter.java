...
public class UndeliveredNotificationsQuery_ResponseAdapter {
  public enum Data implements Adapter<UndeliveredNotificationsQuery.Data> {
    ...
    public UndeliveredNotificationsQuery.Data fromJson(JsonReader reader,
      ...
      Optional<UndeliveredNotificationsQuery.UndeliveredNotifications> _undeliveredNotifications = null;

      loop:
      while(true) {
        switch (reader.selectName(RESPONSE_NAMES)) {
          case 0: _undeliveredNotifications = new OptionalAdapter<>(new ObjectAdapter<UndeliveredNotificationsQuery.UndeliveredNotifications>(UndeliveredNotifications.INSTANCE, false)).fromJson(reader, customScalarAdapters); break;
          default: break loop;
        }
      }
    ...
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
      ...
      new OptionalAdapter<>(new ObjectAdapter<UndeliveredNotificationsQuery.UndeliveredNotifications>(UndeliveredNotifications.INSTANCE, false)).toJson(writer, customScalarAdapters, value.undeliveredNotifications);
    }
  }
  ...
  public enum UndeliveredNotifications implements Adapter<UndeliveredNotificationsQuery.UndeliveredNotifications> {
    ...
    public UndeliveredNotificationsQuery.UndeliveredNotifications fromJson(JsonReader reader,
      ...
      List<Optional<UndeliveredNotificationsQuery.Element>> _elements = null;
      ...
      while(true) {
        switch (reader.selectName(RESPONSE_NAMES)) {
          ...
          case 2: _elements = new ListAdapter<>(new OptionalAdapter<>(new ObjectAdapter<UndeliveredNotificationsQuery.Element>(Element.INSTANCE, false))).fromJson(reader, customScalarAdapters); break;
          default: break loop;
        }
      }
    ...
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
      ...
      new ListAdapter<>(new OptionalAdapter<>(new ObjectAdapter<UndeliveredNotificationsQuery.Element>(Element.INSTANCE, false))).toJson(writer, customScalarAdapters, value.elements);
    }
  }
  ...
  public enum Element implements Adapter<UndeliveredNotificationsQuery.Element> {
    ...
    public UndeliveredNotificationsQuery.Element fromJson(JsonReader reader,
        CustomScalarAdapters customScalarAdapters) throws IOException {
      Optional<UndeliveredNotificationsQuery.Error> _error = null;
      UndeliveredNotificationsQuery.Notification _notification = null;

      loop:
      while(true) {
        switch (reader.selectName(RESPONSE_NAMES)) {
          case 0: _error = new OptionalAdapter<>(new ObjectAdapter<UndeliveredNotificationsQuery.Error>(Error.INSTANCE, false)).fromJson(reader, customScalarAdapters); break;
    ...
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
      ...
      writer.name("error");
      new OptionalAdapter<>(new ObjectAdapter<UndeliveredNotificationsQuery.Error>(Error.INSTANCE, false)).toJson(writer, customScalarAdapters, value.error);
  ...
  public enum Notification implements Adapter<UndeliveredNotificationsQuery.Notification> {
    ...
    public UndeliveredNotificationsQuery.Notification fromJson(JsonReader reader,
      ...
      while(true) {
        switch (reader.selectName(RESPONSE_NAMES)) {
          case 0: _creationDateTime = com.expediagroup.sdk.lodgingconnectivity.graphql.adapter.DateTimeAdapter.INSTANCE.fromJson(reader, customScalarAdapters); break;
