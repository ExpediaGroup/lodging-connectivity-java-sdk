...
import com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.UpdateSingleDiscountPromotionMutation_ResponseAdapter;
import com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.UpdateSingleDiscountPromotionMutation_VariablesAdapter;
import com.expediagroup.sdk.lodgingconnectivity.graphql.supply.selections.UpdateSingleDiscountPromotionMutationSelections;
...
public class UpdateSingleDiscountPromotionMutation implements Mutation<UpdateSingleDiscountPromotionMutation.Data> {
  public static final String OPERATION_ID = "0a748e0b54e35451f501653436da34ed243efe44be332a80db7550c457f3ece0";
   ...
   * }
   */
  public static final String OPERATION_DOCUMENT = "mutation UpdateSingleDiscountPromotion($promotion: SingleDiscountPromotionUpdateInput!, $propertyId: String!, $propertyIdSource: IdSource!) { updateSingleDiscountPromotion(promotion: $promotion, propertyId: $propertyId, propertyIdSource: $propertyIdSource) { __typename category id isContractedPromotion name sellStatus status ... on DiscountPromotion { id name category status code restrictions { isMemberOnly isMobileUserOnly minLengthOfStay maxLengthOfStay minAdvanceBookingDays maxAdvanceBookingDays bookingLocalDateTimeFrom bookingLocalDateTimeTo travelDateFrom travelDateTo sameDayBookingStartTime } blackoutDates { travelDateFrom travelDateTo } discount { __typename ... on SingleDiscount { type unit value memberOnlyAdditionalValue } } sellStatus isContractedPromotion eligibleRatePlans { id } } } }";

  public static final String OPERATION_NAME = "UpdateSingleDiscountPromotion";

  public final SingleDiscountPromotionUpdateInput promotion;
  ...
  public UpdateSingleDiscountPromotionMutation(SingleDiscountPromotionUpdateInput promotion,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof UpdateSingleDiscountPromotionMutation) {
      UpdateSingleDiscountPromotionMutation that = (UpdateSingleDiscountPromotionMutation) o;
  ...
  public String toString() {
    if ($toString == null) {
      $toString = "UpdateSingleDiscountPromotionMutation{"
        + "promotion=" + promotion + ", "
  ...
  public void serializeVariables(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
    ...
    UpdateSingleDiscountPromotionMutation_VariablesAdapter.INSTANCE.serializeVariables(writer, this, customScalarAdapters, withDefaultValues);
  }

  @Override
  public Adapter<Data> adapter() {
    return new ObjectAdapter<Data>(UpdateSingleDiscountPromotionMutation_ResponseAdapter.Data.INSTANCE, false);
  }
  ...
  public CompiledField rootField() {
    ...
    .selections(UpdateSingleDiscountPromotionMutationSelections.__root)
    .build();
  }

  public static final class Builder {
    private SingleDiscountPromotionUpdateInput promotion;
    ...
    public Builder promotion(SingleDiscountPromotionUpdateInput promotion) {
      this.promotion = promotion;
      return this;
    }
    ...
    public UpdateSingleDiscountPromotionMutation build() {
      return new UpdateSingleDiscountPromotionMutation(promotion, propertyId, propertyIdSource);
    }
  }
  ...
  public static class Data implements Mutation.Data {
     ...
     */
    public UpdateSingleDiscountPromotion updateSingleDiscountPromotion;
    ...
    public Data(UpdateSingleDiscountPromotion updateSingleDiscountPromotion) {
      this.updateSingleDiscountPromotion = updateSingleDiscountPromotion;
    }
    ...
    public boolean equals(Object o) {
      ...
      if (o instanceof Data) {
        Data that = (Data) o;
        return ((this.updateSingleDiscountPromotion == null) ? (that.updateSingleDiscountPromotion == null) : this.updateSingleDiscountPromotion.equals(that.updateSingleDiscountPromotion));
      }
      return false;
    }
    ...
    public int hashCode() {
      if (!$hashCodeMemoized) {
        int __h = 1;
        __h *= 1000003;
        __h ^= (updateSingleDiscountPromotion == null) ? 0 : updateSingleDiscountPromotion.hashCode();
        $hashCode = __h;
        $hashCodeMemoized = true;
      }
      return $hashCode;
    ...
    public String toString() {
      if ($toString == null) {
        $toString = "Data{"
          + "updateSingleDiscountPromotion=" + updateSingleDiscountPromotion
          + "}";
      }
      return $toString;
    }
  ...
  public static class UpdateSingleDiscountPromotion {
    ...
    public UpdateSingleDiscountPromotion(String __typename, PromotionCategory category, String id,
    ...
    public boolean equals(Object o) {
      ...
      if (o instanceof UpdateSingleDiscountPromotion) {
        UpdateSingleDiscountPromotion that = (UpdateSingleDiscountPromotion) o;
    ...
    public String toString() {
      if ($toString == null) {
        $toString = "UpdateSingleDiscountPromotion{"
  ...
  public static class OnDiscountPromotion {
    ...
    public OnDiscountPromotion(String id, PromotionName name, PromotionCategory category,
        ...
        Optional<List<BlackoutDate>> blackoutDates, Optional<Discount> discount,
        Optional<PromotionSellStatus> sellStatus, Optional<Boolean> isContractedPromotion,
        List<EligibleRatePlan> eligibleRatePlans) {
      this.id = id;
      this.name = name;
      this.category = category;
      this.status = status;
