...
public class UpdateSingleDiscountPromotionMutation implements Mutation<UpdateSingleDiscountPromotionMutation.Data> {
  ...
  public static class OnDiscountPromotion {
    ...
    public OnDiscountPromotion(String id, PromotionName name, PromotionCategory category,
        ...
        List<BlackoutDate> blackoutDates, Discount discount, PromotionSellStatus sellStatus,
        Boolean isContractedPromotion, List<EligibleRatePlan> eligibleRatePlans) {
      this.id = id;
      this.name = name;
      this.category = category;
      this.status = status;
  ...
  public static class Discount {
    ...
    public Discount(String __typename, OnSingleDiscount onSingleDiscount) {
      this.__typename = __typename;
