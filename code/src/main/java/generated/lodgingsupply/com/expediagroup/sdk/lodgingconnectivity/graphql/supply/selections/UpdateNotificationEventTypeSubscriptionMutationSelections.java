...
public class UpdateNotificationEventTypeSubscriptionMutationSelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("updateNotificationEventTypeSubscription", UpdateNotificationEventTypeSubscriptionPayload.type).arguments(Arrays.asList(new CompiledArgument.Builder(Mutation.__updateNotificationEventTypeSubscription_input).value(new CompiledVariable("input")).build())).selections(__updateNotificationEventTypeSubscription).build()
  );
}
