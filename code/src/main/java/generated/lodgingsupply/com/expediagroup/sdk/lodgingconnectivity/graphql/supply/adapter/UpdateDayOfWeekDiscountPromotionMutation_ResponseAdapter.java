...
public class UpdateDayOfWeekDiscountPromotionMutation_ResponseAdapter {
  ...
  public enum UpdateDayOfWeekDiscountPromotion implements Adapter<UpdateDayOfWeekDiscountPromotionMutation.UpdateDayOfWeekDiscountPromotion> {
    ...
    public UpdateDayOfWeekDiscountPromotionMutation.UpdateDayOfWeekDiscountPromotion fromJson(
      ...
      Optional<UpdateDayOfWeekDiscountPromotionMutation.OnDiscountPromotion> _onDiscountPromotion = Optional.empty();
      if (BooleanExpressions.evaluate(new BooleanExpression.Element<BTerm>(new BPossibleTypes("DiscountPromotion")), customScalarAdapters.falseVariables, __typename, customScalarAdapters.deferredFragmentIdentifiers, null)) {
        reader.rewind();
        _onDiscountPromotion = Optional.of(com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.UpdateDayOfWeekDiscountPromotionMutation_ResponseAdapter.OnDiscountPromotion.INSTANCE.fromJson(reader, customScalarAdapters));
      }
    ...
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
      ...
      if (value.onDiscountPromotion.isPresent()) {
        com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.UpdateDayOfWeekDiscountPromotionMutation_ResponseAdapter.OnDiscountPromotion.INSTANCE.toJson(writer, customScalarAdapters, value.onDiscountPromotion.get());
      }
    }
  }
  ...
  public enum OnDiscountPromotion implements Adapter<UpdateDayOfWeekDiscountPromotionMutation.OnDiscountPromotion> {
    ...
    public UpdateDayOfWeekDiscountPromotionMutation.OnDiscountPromotion fromJson(JsonReader reader,
      ...
      PromotionStatus _status = null;
      String _code = null;
      Optional<UpdateDayOfWeekDiscountPromotionMutation.Restrictions> _restrictions = null;
      List<UpdateDayOfWeekDiscountPromotionMutation.EligibleRatePlan> _eligibleRatePlans = null;
      Optional<List<UpdateDayOfWeekDiscountPromotionMutation.BlackoutDate>> _blackoutDates = null;
      Optional<UpdateDayOfWeekDiscountPromotionMutation.Discount> _discount = null;
      Optional<PromotionSellStatus> _sellStatus = null;
      Optional<Boolean> _isContractedPromotion = null;
      ...
      while(true) {
        switch (reader.selectName(RESPONSE_NAMES)) {
          ...
          case 5: _restrictions = new OptionalAdapter<>(new ObjectAdapter<UpdateDayOfWeekDiscountPromotionMutation.Restrictions>(Restrictions.INSTANCE, false)).fromJson(reader, customScalarAdapters); break;
          ...
          case 7: _blackoutDates = new OptionalAdapter<>(new ListAdapter<>(new ObjectAdapter<UpdateDayOfWeekDiscountPromotionMutation.BlackoutDate>(BlackoutDate.INSTANCE, false))).fromJson(reader, customScalarAdapters); break;
          case 8: _discount = new OptionalAdapter<>(new ObjectAdapter<UpdateDayOfWeekDiscountPromotionMutation.Discount>(Discount.INSTANCE, true)).fromJson(reader, customScalarAdapters); break;
    ...
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
      ...
      new OptionalAdapter<>(new ObjectAdapter<UpdateDayOfWeekDiscountPromotionMutation.Restrictions>(Restrictions.INSTANCE, false)).toJson(writer, customScalarAdapters, value.restrictions);
      ...
      new OptionalAdapter<>(new ListAdapter<>(new ObjectAdapter<UpdateDayOfWeekDiscountPromotionMutation.BlackoutDate>(BlackoutDate.INSTANCE, false))).toJson(writer, customScalarAdapters, value.blackoutDates);

      writer.name("discount");
      new OptionalAdapter<>(new ObjectAdapter<UpdateDayOfWeekDiscountPromotionMutation.Discount>(Discount.INSTANCE, true)).toJson(writer, customScalarAdapters, value.discount);
  ...
  public enum Discount implements Adapter<UpdateDayOfWeekDiscountPromotionMutation.Discount> {
    ...
    public UpdateDayOfWeekDiscountPromotionMutation.Discount fromJson(JsonReader reader,
      ...
      Assertions.checkFieldNotMissing(__typename, "__typename");
      Optional<UpdateDayOfWeekDiscountPromotionMutation.OnDayOfWeekDiscount> _onDayOfWeekDiscount = Optional.empty();
      if (BooleanExpressions.evaluate(new BooleanExpression.Element<BTerm>(new BPossibleTypes("DayOfWeekDiscount")), customScalarAdapters.falseVariables, __typename, customScalarAdapters.deferredFragmentIdentifiers, null)) {
        reader.rewind();
        _onDayOfWeekDiscount = Optional.of(com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.UpdateDayOfWeekDiscountPromotionMutation_ResponseAdapter.OnDayOfWeekDiscount.INSTANCE.fromJson(reader, customScalarAdapters));
      }
    ...
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
      ...
      if (value.onDayOfWeekDiscount.isPresent()) {
        com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.UpdateDayOfWeekDiscountPromotionMutation_ResponseAdapter.OnDayOfWeekDiscount.INSTANCE.toJson(writer, customScalarAdapters, value.onDayOfWeekDiscount.get());
      }
    }
  }
