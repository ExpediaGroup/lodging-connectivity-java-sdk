...
public class MessageThreadMessagesOrderByInput {
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof MessageThreadMessagesOrderByInput) {
      MessageThreadMessagesOrderByInput that = (MessageThreadMessagesOrderByInput) o;
  ...
  public String toString() {
    if ($toString == null) {
      $toString = "MessageThreadMessagesOrderByInput{"
        + "field=" + field + ", "
        + "order=" + order
        + "}";
    }
  ...
  public static final class Builder {
    ...
    public MessageThreadMessagesOrderByInput build() {
      return new MessageThreadMessagesOrderByInput(field, order);
    }
  }
}
