...
public class DistrictByCoordinatesQuerySelections {
  ...
  private static List<CompiledSelection> __districtByCoordinates = Arrays.asList(
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("districtByCoordinates", District.type).arguments(Arrays.asList(new CompiledArgument.Builder(Query.__districtByCoordinates_latitude).value(new CompiledVariable("latitude")).build(), new CompiledArgument.Builder(Query.__districtByCoordinates_locale).value(new CompiledVariable("locale")).build(), new CompiledArgument.Builder(Query.__districtByCoordinates_longitude).value(new CompiledVariable("longitude")).build())).selections(__districtByCoordinates).build()
  );
}
