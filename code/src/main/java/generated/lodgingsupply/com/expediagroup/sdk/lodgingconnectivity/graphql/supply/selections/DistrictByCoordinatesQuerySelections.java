...
public class DistrictByCoordinatesQuerySelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("districtByCoordinates", District.type).arguments(Arrays.asList(new CompiledArgument.Builder("latitude", new CompiledVariable("latitude")).build(), new CompiledArgument.Builder("locale", new CompiledVariable("locale")).build(), new CompiledArgument.Builder("longitude", new CompiledVariable("longitude")).build())).selections(__districtByCoordinates).build()
  );
}
