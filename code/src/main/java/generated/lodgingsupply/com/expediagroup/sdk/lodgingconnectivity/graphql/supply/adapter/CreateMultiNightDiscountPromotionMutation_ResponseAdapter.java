...
public class CreateMultiNightDiscountPromotionMutation_ResponseAdapter {
  public enum Data implements Adapter<CreateMultiNightDiscountPromotionMutation.Data> {
    INSTANCE;

    private static final List<String> RESPONSE_NAMES = Arrays.asList("createMultiNightDiscountPromotion");

    @Override
    public CreateMultiNightDiscountPromotionMutation.Data fromJson(JsonReader reader,
        CustomScalarAdapters customScalarAdapters) throws IOException {
      CreateMultiNightDiscountPromotionMutation.CreateMultiNightDiscountPromotion _createMultiNightDiscountPromotion = null;

      loop:
      while(true) {
        switch (reader.selectName(RESPONSE_NAMES)) {
          case 0: _createMultiNightDiscountPromotion = new ObjectAdapter<CreateMultiNightDiscountPromotionMutation.CreateMultiNightDiscountPromotion>(CreateMultiNightDiscountPromotion.INSTANCE, true).fromJson(reader, customScalarAdapters); break;
          default: break loop;
        }
      }

      Assertions.checkFieldNotMissing(_createMultiNightDiscountPromotion, "createMultiNightDiscountPromotion");

      return new CreateMultiNightDiscountPromotionMutation.Data(
        _createMultiNightDiscountPromotion
      );
    }

    @Override
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
        CreateMultiNightDiscountPromotionMutation.Data value) throws IOException {
      writer.name("createMultiNightDiscountPromotion");
      new ObjectAdapter<CreateMultiNightDiscountPromotionMutation.CreateMultiNightDiscountPromotion>(CreateMultiNightDiscountPromotion.INSTANCE, true).toJson(writer, customScalarAdapters, value.createMultiNightDiscountPromotion);
    }
  }

  public enum CreateMultiNightDiscountPromotion implements Adapter<CreateMultiNightDiscountPromotionMutation.CreateMultiNightDiscountPromotion> {
    INSTANCE;
    ...
    @Override
    public CreateMultiNightDiscountPromotionMutation.CreateMultiNightDiscountPromotion fromJson(
      ...
      CreateMultiNightDiscountPromotionMutation.OnDiscountPromotion _onDiscountPromotion = null;
      if (BooleanExpressions.evaluate(new BooleanExpression.Element<BTerm>(new BPossibleTypes("DiscountPromotion")), customScalarAdapters.getAdapterContext().variables(), __typename, customScalarAdapters.getAdapterContext(), null)) {
        reader.rewind();
        _onDiscountPromotion = com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.CreateMultiNightDiscountPromotionMutation_ResponseAdapter.OnDiscountPromotion.INSTANCE.fromJson(reader, customScalarAdapters);
      }
      ...
      return new CreateMultiNightDiscountPromotionMutation.CreateMultiNightDiscountPromotion(
        __typename,
        _category,
        _id,
    ...
    @Override
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
        CreateMultiNightDiscountPromotionMutation.CreateMultiNightDiscountPromotion value) throws
        IOException {
      ...
      if (value.onDiscountPromotion != null) {
        com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.CreateMultiNightDiscountPromotionMutation_ResponseAdapter.OnDiscountPromotion.INSTANCE.toJson(writer, customScalarAdapters, value.onDiscountPromotion);
      }
    }
  }

  public enum OnDiscountPromotion implements Adapter<CreateMultiNightDiscountPromotionMutation.OnDiscountPromotion> {
    INSTANCE;
    ...
    @Override
    public CreateMultiNightDiscountPromotionMutation.OnDiscountPromotion fromJson(JsonReader reader,
        CustomScalarAdapters customScalarAdapters) throws IOException {
      String _id = null;
      PromotionName _name = null;
      PromotionCategory _category = null;
      PromotionStatus _status = null;
      String _code = null;
      CreateMultiNightDiscountPromotionMutation.Restrictions _restrictions = null;
      List<CreateMultiNightDiscountPromotionMutation.EligibleRatePlan> _eligibleRatePlans = null;
      List<CreateMultiNightDiscountPromotionMutation.BlackoutDate> _blackoutDates = null;
      CreateMultiNightDiscountPromotionMutation.Discount _discount = null;
      PromotionSellStatus _sellStatus = null;
      Boolean _isContractedPromotion = null;
      ...
      while(true) {
        switch (reader.selectName(RESPONSE_NAMES)) {
          ...
          case 5: _restrictions = new NullableAdapter<>(new ObjectAdapter<CreateMultiNightDiscountPromotionMutation.Restrictions>(Restrictions.INSTANCE, false)).fromJson(reader, customScalarAdapters); break;
          case 6: _eligibleRatePlans = new ListAdapter<>(new ObjectAdapter<CreateMultiNightDiscountPromotionMutation.EligibleRatePlan>(EligibleRatePlan.INSTANCE, false)).fromJson(reader, customScalarAdapters); break;
          case 7: _blackoutDates = new NullableAdapter<>(new ListAdapter<>(new ObjectAdapter<CreateMultiNightDiscountPromotionMutation.BlackoutDate>(BlackoutDate.INSTANCE, false))).fromJson(reader, customScalarAdapters); break;
          case 8: _discount = new NullableAdapter<>(new ObjectAdapter<CreateMultiNightDiscountPromotionMutation.Discount>(Discount.INSTANCE, true)).fromJson(reader, customScalarAdapters); break;
      ...
      return new CreateMultiNightDiscountPromotionMutation.OnDiscountPromotion(
        _id,
        _name,
        _category,
        _status,
    ...
    @Override
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
        CreateMultiNightDiscountPromotionMutation.OnDiscountPromotion value) throws IOException {
      writer.name("id");
      Adapters.StringAdapter.toJson(writer, customScalarAdapters, value.id);
      ...
      new NullableAdapter<>(new ObjectAdapter<CreateMultiNightDiscountPromotionMutation.Restrictions>(Restrictions.INSTANCE, false)).toJson(writer, customScalarAdapters, value.restrictions);

      writer.name("eligibleRatePlans");
      new ListAdapter<>(new ObjectAdapter<CreateMultiNightDiscountPromotionMutation.EligibleRatePlan>(EligibleRatePlan.INSTANCE, false)).toJson(writer, customScalarAdapters, value.eligibleRatePlans);

      writer.name("blackoutDates");
      new NullableAdapter<>(new ListAdapter<>(new ObjectAdapter<CreateMultiNightDiscountPromotionMutation.BlackoutDate>(BlackoutDate.INSTANCE, false))).toJson(writer, customScalarAdapters, value.blackoutDates);

      writer.name("discount");
      new NullableAdapter<>(new ObjectAdapter<CreateMultiNightDiscountPromotionMutation.Discount>(Discount.INSTANCE, true)).toJson(writer, customScalarAdapters, value.discount);
  ...
  public enum Restrictions implements Adapter<CreateMultiNightDiscountPromotionMutation.Restrictions> {
    INSTANCE;
    ...
    @Override
    public CreateMultiNightDiscountPromotionMutation.Restrictions fromJson(JsonReader reader,
        CustomScalarAdapters customScalarAdapters) throws IOException {
      ...
      return new CreateMultiNightDiscountPromotionMutation.Restrictions(
        _isMemberOnly,
        _isMobileUserOnly,
        _minLengthOfStay,
        _maxLengthOfStay,
    ...
    @Override
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
        CreateMultiNightDiscountPromotionMutation.Restrictions value) throws IOException {
  ...
  public enum EligibleRatePlan implements Adapter<CreateMultiNightDiscountPromotionMutation.EligibleRatePlan> {
    INSTANCE;

    private static final List<String> RESPONSE_NAMES = Arrays.asList("id");

    @Override
    public CreateMultiNightDiscountPromotionMutation.EligibleRatePlan fromJson(JsonReader reader,
        CustomScalarAdapters customScalarAdapters) throws IOException {
      String _id = null;
      ...
      return new CreateMultiNightDiscountPromotionMutation.EligibleRatePlan(
        _id
      );
    }
    ...
    @Override
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
        CreateMultiNightDiscountPromotionMutation.EligibleRatePlan value) throws IOException {
      writer.name("id");
      Adapters.StringAdapter.toJson(writer, customScalarAdapters, value.id);
    }
  }

  public enum BlackoutDate implements Adapter<CreateMultiNightDiscountPromotionMutation.BlackoutDate> {
    INSTANCE;

    private static final List<String> RESPONSE_NAMES = Arrays.asList("travelDateFrom", "travelDateTo");

    @Override
    public CreateMultiNightDiscountPromotionMutation.BlackoutDate fromJson(JsonReader reader,
        CustomScalarAdapters customScalarAdapters) throws IOException {
      LocalDate _travelDateFrom = null;
      LocalDate _travelDateTo = null;
      ...
      return new CreateMultiNightDiscountPromotionMutation.BlackoutDate(
        _travelDateFrom,
        _travelDateTo
      );
    }
    ...
    @Override
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
        CreateMultiNightDiscountPromotionMutation.BlackoutDate value) throws IOException {
      writer.name("travelDateFrom");
  ...
  public enum Discount implements Adapter<CreateMultiNightDiscountPromotionMutation.Discount> {
    INSTANCE;

    private static final List<String> RESPONSE_NAMES = Arrays.asList("__typename");

    @Override
    public CreateMultiNightDiscountPromotionMutation.Discount fromJson(JsonReader reader,
        CustomScalarAdapters customScalarAdapters) throws IOException {
      String __typename = null;
      ...
      Assertions.checkFieldNotMissing(__typename, "__typename");
      CreateMultiNightDiscountPromotionMutation.OnMultiNightDiscount _onMultiNightDiscount = null;
      if (BooleanExpressions.evaluate(new BooleanExpression.Element<BTerm>(new BPossibleTypes("MultiNightDiscount")), customScalarAdapters.getAdapterContext().variables(), __typename, customScalarAdapters.getAdapterContext(), null)) {
        reader.rewind();
        _onMultiNightDiscount = com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.CreateMultiNightDiscountPromotionMutation_ResponseAdapter.OnMultiNightDiscount.INSTANCE.fromJson(reader, customScalarAdapters);
      }

      return new CreateMultiNightDiscountPromotionMutation.Discount(
        __typename,
    ...
    @Override
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
        CreateMultiNightDiscountPromotionMutation.Discount value) throws IOException {
      writer.name("__typename");
      Adapters.StringAdapter.toJson(writer, customScalarAdapters, value.__typename);

      if (value.onMultiNightDiscount != null) {
        com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.CreateMultiNightDiscountPromotionMutation_ResponseAdapter.OnMultiNightDiscount.INSTANCE.toJson(writer, customScalarAdapters, value.onMultiNightDiscount);
      }
    }
  }

  public enum OnMultiNightDiscount implements Adapter<CreateMultiNightDiscountPromotionMutation.OnMultiNightDiscount> {
    INSTANCE;
    ...
    @Override
    public CreateMultiNightDiscountPromotionMutation.OnMultiNightDiscount fromJson(
        JsonReader reader, CustomScalarAdapters customScalarAdapters) throws IOException {
      ...
      return new CreateMultiNightDiscountPromotionMutation.OnMultiNightDiscount(
        _type,
        _unit,
        _value,
    ...
    @Override
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
        CreateMultiNightDiscountPromotionMutation.OnMultiNightDiscount value) throws IOException {
      writer.name("type");
