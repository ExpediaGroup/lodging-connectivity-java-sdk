...
public class CreateMultiNightDiscountPromotionMutation_ResponseAdapter {
  ...
  public enum CreateMultiNightDiscountPromotion implements Adapter<CreateMultiNightDiscountPromotionMutation.CreateMultiNightDiscountPromotion> {
    ...
    public CreateMultiNightDiscountPromotionMutation.CreateMultiNightDiscountPromotion fromJson(
      ...
      Optional<CreateMultiNightDiscountPromotionMutation.OnDiscountPromotion> _onDiscountPromotion = Optional.empty();
      if (BooleanExpressions.evaluate(new BooleanExpression.Element<BTerm>(new BPossibleTypes("DiscountPromotion")), customScalarAdapters.falseVariables, __typename, customScalarAdapters.deferredFragmentIdentifiers, null)) {
        reader.rewind();
        _onDiscountPromotion = Optional.of(com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.CreateMultiNightDiscountPromotionMutation_ResponseAdapter.OnDiscountPromotion.INSTANCE.fromJson(reader, customScalarAdapters));
      }
    ...
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
      ...
      if (value.onDiscountPromotion.isPresent()) {
        com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.CreateMultiNightDiscountPromotionMutation_ResponseAdapter.OnDiscountPromotion.INSTANCE.toJson(writer, customScalarAdapters, value.onDiscountPromotion.get());
      }
    }
  }
  ...
  public enum OnDiscountPromotion implements Adapter<CreateMultiNightDiscountPromotionMutation.OnDiscountPromotion> {
    ...
    public CreateMultiNightDiscountPromotionMutation.OnDiscountPromotion fromJson(JsonReader reader,
      ...
      PromotionStatus _status = null;
      String _code = null;
      Optional<CreateMultiNightDiscountPromotionMutation.Restrictions> _restrictions = null;
      List<CreateMultiNightDiscountPromotionMutation.EligibleRatePlan> _eligibleRatePlans = null;
      Optional<List<CreateMultiNightDiscountPromotionMutation.BlackoutDate>> _blackoutDates = null;
      Optional<CreateMultiNightDiscountPromotionMutation.Discount> _discount = null;
      Optional<PromotionSellStatus> _sellStatus = null;
      Optional<Boolean> _isContractedPromotion = null;
      ...
      while(true) {
        switch (reader.selectName(RESPONSE_NAMES)) {
          ...
          case 5: _restrictions = new OptionalAdapter<>(new ObjectAdapter<CreateMultiNightDiscountPromotionMutation.Restrictions>(Restrictions.INSTANCE, false)).fromJson(reader, customScalarAdapters); break;
          ...
          case 7: _blackoutDates = new OptionalAdapter<>(new ListAdapter<>(new ObjectAdapter<CreateMultiNightDiscountPromotionMutation.BlackoutDate>(BlackoutDate.INSTANCE, false))).fromJson(reader, customScalarAdapters); break;
          case 8: _discount = new OptionalAdapter<>(new ObjectAdapter<CreateMultiNightDiscountPromotionMutation.Discount>(Discount.INSTANCE, true)).fromJson(reader, customScalarAdapters); break;
    ...
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
      ...
      new OptionalAdapter<>(new ObjectAdapter<CreateMultiNightDiscountPromotionMutation.Restrictions>(Restrictions.INSTANCE, false)).toJson(writer, customScalarAdapters, value.restrictions);
      ...
      new OptionalAdapter<>(new ListAdapter<>(new ObjectAdapter<CreateMultiNightDiscountPromotionMutation.BlackoutDate>(BlackoutDate.INSTANCE, false))).toJson(writer, customScalarAdapters, value.blackoutDates);

      writer.name("discount");
      new OptionalAdapter<>(new ObjectAdapter<CreateMultiNightDiscountPromotionMutation.Discount>(Discount.INSTANCE, true)).toJson(writer, customScalarAdapters, value.discount);
  ...
  public enum Discount implements Adapter<CreateMultiNightDiscountPromotionMutation.Discount> {
    ...
    public CreateMultiNightDiscountPromotionMutation.Discount fromJson(JsonReader reader,
      ...
      Assertions.checkFieldNotMissing(__typename, "__typename");
      Optional<CreateMultiNightDiscountPromotionMutation.OnMultiNightDiscount> _onMultiNightDiscount = Optional.empty();
      if (BooleanExpressions.evaluate(new BooleanExpression.Element<BTerm>(new BPossibleTypes("MultiNightDiscount")), customScalarAdapters.falseVariables, __typename, customScalarAdapters.deferredFragmentIdentifiers, null)) {
        reader.rewind();
        _onMultiNightDiscount = Optional.of(com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.CreateMultiNightDiscountPromotionMutation_ResponseAdapter.OnMultiNightDiscount.INSTANCE.fromJson(reader, customScalarAdapters));
      }
    ...
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
      ...
      if (value.onMultiNightDiscount.isPresent()) {
        com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.CreateMultiNightDiscountPromotionMutation_ResponseAdapter.OnMultiNightDiscount.INSTANCE.toJson(writer, customScalarAdapters, value.onMultiNightDiscount.get());
      }
    }
  }
