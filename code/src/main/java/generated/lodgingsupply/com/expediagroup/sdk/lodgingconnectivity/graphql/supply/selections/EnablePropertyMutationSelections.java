...
import com.expediagroup.sdk.lodgingconnectivity.graphql.supply.type.EnablePropertyPayload;
...
public class EnablePropertyMutationSelections {
  private static List<CompiledSelection> __enableProperty = Arrays.asList(
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("enableProperty", EnablePropertyPayload.type).arguments(Arrays.asList(new CompiledArgument.Builder(Mutation.__enableProperty_input).value(new CompiledVariable("input")).build())).selections(__enableProperty).build()
  );
}
