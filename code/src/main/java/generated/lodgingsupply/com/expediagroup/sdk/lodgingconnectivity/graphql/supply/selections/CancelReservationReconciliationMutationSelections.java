...
public class CancelReservationReconciliationMutationSelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("cancelReservationReconciliation", new CompiledNotNullType(CancelReservationReconciliationPayload.type)).arguments(Arrays.asList(new CompiledArgument.Builder(Mutation.__cancelReservationReconciliation_input).value(new CompiledVariable("input")).build())).selections(__cancelReservationReconciliation).build()
  );
}
