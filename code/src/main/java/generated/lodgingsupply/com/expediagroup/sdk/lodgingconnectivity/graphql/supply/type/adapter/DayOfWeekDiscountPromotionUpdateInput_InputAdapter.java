...
public enum DayOfWeekDiscountPromotionUpdateInput_InputAdapter implements Adapter<DayOfWeekDiscountPromotionUpdateInput> {
  ...
  public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
    ...
    if (value.discount.isPresent()) {
      ...
      new OptionalAdapter<>(new OptionalAdapter<>(new ObjectAdapter<DayOfWeekDiscountUpdateInput>(DayOfWeekDiscountUpdateInput_InputAdapter.INSTANCE, false))).toJson(writer, customScalarAdapters, value.discount);
    }
  }
}
