...
public class MessageThreadQuerySelections {
  ...
  private static List<CompiledSelection> __messageThread = Arrays.asList(
    ...
    new CompiledField.Builder("messages", new CompiledNotNullType(MessageThreadMessagesResponse.type)).arguments(Arrays.asList(new CompiledArgument.Builder("cursor", new CompiledVariable("messagesCursor")).build(), new CompiledArgument.Builder("limit", new CompiledVariable("messagesLimit")).build(), new CompiledArgument.Builder("orderBy", new CompiledVariable("orderMessagesBy")).build())).selections(__messages).build()
  );

  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("messageThread", MessageThread.type).arguments(Arrays.asList(new CompiledArgument.Builder("id", new CompiledVariable("messageThreadId")).build())).selections(__messageThread).build()
  );
}
