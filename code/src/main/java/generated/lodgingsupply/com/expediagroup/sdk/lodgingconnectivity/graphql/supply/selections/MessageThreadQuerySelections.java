...
public class MessageThreadQuerySelections {
  ...
  private static List<CompiledSelection> __messageThread = Arrays.asList(
    ...
    new CompiledField.Builder("messages", new CompiledNotNullType(MessageThreadMessagesResponse.type)).arguments(Arrays.asList(new CompiledArgument.Builder(MessageThread.__messages_cursor).value(new CompiledVariable("messagesCursor")).build(), new CompiledArgument.Builder(MessageThread.__messages_limit).value(new CompiledVariable("messagesLimit")).build(), new CompiledArgument.Builder(MessageThread.__messages_orderBy).value(new CompiledVariable("orderMessagesBy")).build())).selections(__messages).build()
  );

  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("messageThread", MessageThread.type).arguments(Arrays.asList(new CompiledArgument.Builder(Query.__messageThread_id).value(new CompiledVariable("messageThreadId")).build())).selections(__messageThread).build()
  );
}
