...
public class RestrictionsUpdateInput {
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof RestrictionsUpdateInput) {
      RestrictionsUpdateInput that = (RestrictionsUpdateInput) o;
  ...
  public String toString() {
    if ($toString == null) {
      $toString = "RestrictionsUpdateInput{"
  ...
  public static final class Builder {
    ...
    public RestrictionsUpdateInput build() {
      return new RestrictionsUpdateInput(isMemberOnly, isMobileUserOnly, minLengthOfStay, maxLengthOfStay, minAdvanceBookingDays, maxAdvanceBookingDays, bookingLocalDateTimeFrom, bookingLocalDateTimeTo, travelDateFrom, travelDateTo, sameDayBookingStartTime);
    }
  }
}
