...
public class PropertyMessagesQuerySelections {
  ...
  private static List<CompiledSelection> __property = Arrays.asList(
    new CompiledField.Builder("messages", MessageThreadMessagesResponse.type).arguments(Arrays.asList(new CompiledArgument.Builder("cursor", new CompiledVariable("cursor")).build(), new CompiledArgument.Builder("filters", new CompiledVariable("filters")).build(), new CompiledArgument.Builder("limit", new CompiledVariable("limit")).build())).selections(__messages).build()
  );
