...
public class DayOfWeekDiscountPromotionUpdateInput {
  ...
  public final Optional<Optional<DayOfWeekDiscountUpdateInput>> discount;
  ...
  public DayOfWeekDiscountPromotionUpdateInput(String id, Optional<Optional<PromotionName>> name,
      ...
      Optional<Optional<DayOfWeekDiscountUpdateInput>> discount) {
    this.id = id;
    this.name = name;
    this.status = status;
  ...
  public static final class Builder {
    ...
    private Optional<Optional<DayOfWeekDiscountUpdateInput>> discount = Optional.empty();
     ...
     */
    public Builder discount(@NotNull Optional<DayOfWeekDiscountUpdateInput> discount) {
