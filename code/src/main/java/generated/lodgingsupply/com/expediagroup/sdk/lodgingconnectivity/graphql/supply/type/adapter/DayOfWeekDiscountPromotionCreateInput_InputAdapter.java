...
public enum DayOfWeekDiscountPromotionCreateInput_InputAdapter implements Adapter<DayOfWeekDiscountPromotionCreateInput> {
  INSTANCE;

  @Override
  public DayOfWeekDiscountPromotionCreateInput fromJson(JsonReader reader,
  ...
  public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
      DayOfWeekDiscountPromotionCreateInput value) throws IOException {
    writer.name("name");
    ...
    new ObjectAdapter<DayOfWeekDiscountCreateInput>(DayOfWeekDiscountCreateInput_InputAdapter.INSTANCE, false).toJson(writer, customScalarAdapters, value.discount);
  }
}
