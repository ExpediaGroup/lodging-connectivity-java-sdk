...
public class CreateDayOfWeekDiscountPromotionMutation_ResponseAdapter {
  ...
  public enum CreateDayOfWeekDiscountPromotion implements Adapter<CreateDayOfWeekDiscountPromotionMutation.CreateDayOfWeekDiscountPromotion> {
    ...
    public CreateDayOfWeekDiscountPromotionMutation.CreateDayOfWeekDiscountPromotion fromJson(
      ...
      Optional<CreateDayOfWeekDiscountPromotionMutation.OnDiscountPromotion> _onDiscountPromotion = Optional.empty();
      if (BooleanExpressions.evaluate(new BooleanExpression.Element<BTerm>(new BPossibleTypes("DiscountPromotion")), customScalarAdapters.falseVariables, __typename, customScalarAdapters.deferredFragmentIdentifiers, null)) {
        reader.rewind();
        _onDiscountPromotion = Optional.of(com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.CreateDayOfWeekDiscountPromotionMutation_ResponseAdapter.OnDiscountPromotion.INSTANCE.fromJson(reader, customScalarAdapters));
      }
    ...
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
      ...
      if (value.onDiscountPromotion.isPresent()) {
        com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.CreateDayOfWeekDiscountPromotionMutation_ResponseAdapter.OnDiscountPromotion.INSTANCE.toJson(writer, customScalarAdapters, value.onDiscountPromotion.get());
      }
    }
  }
  ...
  public enum OnDiscountPromotion implements Adapter<CreateDayOfWeekDiscountPromotionMutation.OnDiscountPromotion> {
    ...
    public CreateDayOfWeekDiscountPromotionMutation.OnDiscountPromotion fromJson(JsonReader reader,
      ...
      PromotionStatus _status = null;
      String _code = null;
      Optional<CreateDayOfWeekDiscountPromotionMutation.Restrictions> _restrictions = null;
      List<CreateDayOfWeekDiscountPromotionMutation.EligibleRatePlan> _eligibleRatePlans = null;
      Optional<List<CreateDayOfWeekDiscountPromotionMutation.BlackoutDate>> _blackoutDates = null;
      Optional<CreateDayOfWeekDiscountPromotionMutation.Discount> _discount = null;
      Optional<PromotionSellStatus> _sellStatus = null;
      Optional<Boolean> _isContractedPromotion = null;
      ...
      while(true) {
        switch (reader.selectName(RESPONSE_NAMES)) {
          ...
          case 5: _restrictions = new OptionalAdapter<>(new ObjectAdapter<CreateDayOfWeekDiscountPromotionMutation.Restrictions>(Restrictions.INSTANCE, false)).fromJson(reader, customScalarAdapters); break;
          ...
          case 7: _blackoutDates = new OptionalAdapter<>(new ListAdapter<>(new ObjectAdapter<CreateDayOfWeekDiscountPromotionMutation.BlackoutDate>(BlackoutDate.INSTANCE, false))).fromJson(reader, customScalarAdapters); break;
          case 8: _discount = new OptionalAdapter<>(new ObjectAdapter<CreateDayOfWeekDiscountPromotionMutation.Discount>(Discount.INSTANCE, true)).fromJson(reader, customScalarAdapters); break;
    ...
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
      ...
      new OptionalAdapter<>(new ObjectAdapter<CreateDayOfWeekDiscountPromotionMutation.Restrictions>(Restrictions.INSTANCE, false)).toJson(writer, customScalarAdapters, value.restrictions);
      ...
      new OptionalAdapter<>(new ListAdapter<>(new ObjectAdapter<CreateDayOfWeekDiscountPromotionMutation.BlackoutDate>(BlackoutDate.INSTANCE, false))).toJson(writer, customScalarAdapters, value.blackoutDates);

      writer.name("discount");
      new OptionalAdapter<>(new ObjectAdapter<CreateDayOfWeekDiscountPromotionMutation.Discount>(Discount.INSTANCE, true)).toJson(writer, customScalarAdapters, value.discount);
  ...
  public enum Discount implements Adapter<CreateDayOfWeekDiscountPromotionMutation.Discount> {
    ...
    public CreateDayOfWeekDiscountPromotionMutation.Discount fromJson(JsonReader reader,
      ...
      Assertions.checkFieldNotMissing(__typename, "__typename");
      Optional<CreateDayOfWeekDiscountPromotionMutation.OnDayOfWeekDiscount> _onDayOfWeekDiscount = Optional.empty();
      if (BooleanExpressions.evaluate(new BooleanExpression.Element<BTerm>(new BPossibleTypes("DayOfWeekDiscount")), customScalarAdapters.falseVariables, __typename, customScalarAdapters.deferredFragmentIdentifiers, null)) {
        reader.rewind();
        _onDayOfWeekDiscount = Optional.of(com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.CreateDayOfWeekDiscountPromotionMutation_ResponseAdapter.OnDayOfWeekDiscount.INSTANCE.fromJson(reader, customScalarAdapters));
      }
    ...
    public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
      ...
      if (value.onDayOfWeekDiscount.isPresent()) {
        com.expediagroup.sdk.lodgingconnectivity.graphql.supply.adapter.CreateDayOfWeekDiscountPromotionMutation_ResponseAdapter.OnDayOfWeekDiscount.INSTANCE.toJson(writer, customScalarAdapters, value.onDayOfWeekDiscount.get());
      }
    }
  }
