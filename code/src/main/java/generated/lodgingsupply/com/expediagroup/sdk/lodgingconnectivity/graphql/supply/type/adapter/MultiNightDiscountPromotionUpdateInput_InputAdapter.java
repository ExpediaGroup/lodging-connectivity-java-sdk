...
public enum MultiNightDiscountPromotionUpdateInput_InputAdapter implements Adapter<MultiNightDiscountPromotionUpdateInput> {
  ...
  public void toJson(JsonWriter writer, CustomScalarAdapters customScalarAdapters,
    ...
    if (value.discount.isPresent()) {
      ...
      new OptionalAdapter<>(new OptionalAdapter<>(new ObjectAdapter<MultiNightDiscountUpdateInput>(MultiNightDiscountUpdateInput_InputAdapter.INSTANCE, false))).toJson(writer, customScalarAdapters, value.discount);
    }
  }
}
