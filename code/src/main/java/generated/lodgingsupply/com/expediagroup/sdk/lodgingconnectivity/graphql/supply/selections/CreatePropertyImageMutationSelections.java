...
import com.expediagroup.sdk.lodgingconnectivity.graphql.supply.type.CreatePropertyImagePayload;
...
public class CreatePropertyImageMutationSelections {
  ...
  private static List<CompiledSelection> __createPropertyImage = Arrays.asList(
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("createPropertyImage", CreatePropertyImagePayload.type).arguments(Arrays.asList(new CompiledArgument.Builder(Mutation.__createPropertyImage_input).value(new CompiledVariable("input")).build())).selections(__createPropertyImage).build()
  );
}
