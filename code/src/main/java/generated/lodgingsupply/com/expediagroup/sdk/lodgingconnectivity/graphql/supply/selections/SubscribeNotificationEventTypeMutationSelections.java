...
public class SubscribeNotificationEventTypeMutationSelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("subscribeNotificationEventType", SubscribeNotificationEventTypePayload.type).arguments(Arrays.asList(new CompiledArgument.Builder("input", new CompiledVariable("input")).build())).selections(__subscribeNotificationEventType).build()
  );
}
