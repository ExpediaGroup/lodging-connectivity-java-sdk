...
import com.expediagroup.sdk.lodgingconnectivity.graphql.supply.type.UpdateNotificationCallbackConfigPayload;
import com.expediagroup.sdk.lodgingconnectivity.graphql.supply.type.Url;
import java.util.Arrays;
import java.util.List;

public class UpdateNotificationCallbackConfigMutationSelections {
  ...
  private static List<CompiledSelection> __updateNotificationCallbackConfig = Arrays.asList(
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("updateNotificationCallbackConfig", UpdateNotificationCallbackConfigPayload.type).arguments(Arrays.asList(new CompiledArgument.Builder(Mutation.__updateNotificationCallbackConfig_input).value(new CompiledVariable("input")).build())).selections(__updateNotificationCallbackConfig).build()
  );
}
