...
public class UpdateNotificationCallbackConfigMutationSelections {
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("updateNotificationCallbackConfig", UpdateNotificationCallbackConfigPayload.type).arguments(Arrays.asList(new CompiledArgument.Builder("input", new CompiledVariable("input")).build())).selections(__updateNotificationCallbackConfig).build()
  );
}
