...
abstract class AbstractAsyncRequestExecutor(asyncTransport: AsyncTransport? = null) : Disposable {
    ...
    companion object {
        private fun loadTransport(): AsyncTransport {
            return ServiceLoader.load(AsyncTransport::class.java).firstOrNull().getOrThrow {
                ExpediaGroupConfigurationException("No AsyncTransport implementation found. Please include a valid client dependency.")
            }
        }
    }
}
