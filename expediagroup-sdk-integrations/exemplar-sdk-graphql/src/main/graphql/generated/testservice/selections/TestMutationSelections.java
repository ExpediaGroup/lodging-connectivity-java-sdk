...
public class TestMutationSelections {
  private static List<CompiledSelection> __testMutation = Arrays.asList(
  ...
  public static List<CompiledSelection> __root = Arrays.asList(
    new CompiledField.Builder("testMutation", new CompiledNotNullType(TestData.type)).selections(__testMutation).build()
  );
}
